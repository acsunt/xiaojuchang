  ...
  return (
    ...
    >
      <div className="modal-panel stack-gap-md update-prompt-modal">
        <h3 id="update-prompt-title" className="modal-title">
          发现新功能更新
        </h3>

        <div className="stack-gap-sm">
          <p className="sub-copy">检测到网页有新版本，是否立即刷新以加载最新功能？</p>
        ...
        <section className="update-prompt-changelog stack-gap-sm">
          ...
          <button className="update-changelog-link" onClick={openVisitorChangelog} type="button">
            更新日志
          </button>
        </section>
